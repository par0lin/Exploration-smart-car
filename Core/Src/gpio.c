...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
                           ...
                           PEPin PEPin */
  GPIO_InitStruct.Pin = F3_Pin|F7_Pin|F8_Pin|F6_Pin
                          |F4_Pin|L5_Pin|L8_Pin|L7_Pin
                          |F2_Pin|F1_Pin;
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PCPin PCPin */
  GPIO_InitStruct.Pin = KEY1_Pin|KEY2_Pin|KEY3_Pin|L4_Pin
                          |M1_Pin|M2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = L6_Pin|L3_Pin|R6_Pin|R7_Pin
                          |R4_Pin|F5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = R8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(R8_GPIO_Port, &GPIO_InitStruct);
